...
function test() {
  const status = Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('http://localhost:5001/test').then(response => response.json().then(data => {
      console.log(data);
...
module.exports = __webpack_require__(/*! /home/oem/PGN-Buddy_v2/pages/test.js */"./pages/test.js");
