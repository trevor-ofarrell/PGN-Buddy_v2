...
function LoginTab() {
  ...
  function handleSubmit(values, actions) {
    ...
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('https://localhost:3000/login', options).then(response => console.log(response)).catch(error => console.error(error));
  }
...
//# sourceMappingURL=login.js.f751c75323ad2655a9f6.hot-update.js.map