...
function LoginTab() {
  ...
  function handleSubmit(values, actions) {
    ...
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('https://localhost:/login', options).then(response => console.log(response)).catch(error => console.error(error));
  }
...
//# sourceMappingURL=login.js.bbc5449b84792fe6151b.hot-update.js.map