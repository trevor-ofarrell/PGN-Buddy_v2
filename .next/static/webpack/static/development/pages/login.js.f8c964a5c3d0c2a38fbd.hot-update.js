...
function LoginTab() {
  ...
  function handleSubmit(values, actions) {
    ...
    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('http://localhost:5001/login', values).then(response => console.log(response)).catch(error => console.error(error));
  }
...
//# sourceMappingURL=login.js.f8c964a5c3d0c2a38fbd.hot-update.js.map