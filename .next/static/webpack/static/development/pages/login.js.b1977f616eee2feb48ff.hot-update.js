...
function LoginTab() {
  ...
  function handleSubmit(values, actions) {
    ...
    for (let key in values) {
      cred.body.append(key, values[key]);
      console.log(values);
    }

    isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('http://localhost:5001/test', options).then(response => console.log(response)).catch(error => console.error(error));
  }
...
//# sourceMappingURL=login.js.b1977f616eee2feb48ff.hot-update.js.map